...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_60_ansi_split_bs_rshift(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                  LT(1, KC_SPC),                           KC_LALT, MO(1),    KC_APP, KC_RCTL),
  // 0: Base Layer
  [1] = LAYOUT_60_ansi_split_bs_rshift(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_BSLS,   KC_DEL,   \
     _______, _______,   KC_UP,   _______,   _______,  _______,  _______,  _______,  _______,  _______,   _______,   HC_DSK_LEFT, HC_DSK_RIGHT,    KC_DEL,   \
