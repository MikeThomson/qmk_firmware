...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, MO(_FN1), KC_LALT,KC_BSPC,           HC_SPCFN1,HC_SPCFN1, KC_RALT, MO(_FN1), KC_LEFT, KC_DOWN, KC_RCTL
  ),

  [_FN1] = LAYOUT(
    KC_GRV, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_BSPC, \
    _______, _______, KC_UP, _______,   _______, _______, _______, _______, _______, _______, _______, HC_DSKL, HC_DSKR, _______, \
