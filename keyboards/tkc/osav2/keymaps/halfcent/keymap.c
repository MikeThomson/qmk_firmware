...
[0] = LAYOUT_all(
  ...
  KC_PGDN, KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
           KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,	                     KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_LEAD,
           KC_LGUI,          KC_LALT,          KC_BSPC,  MO(1),                     HC_SPCFN1,                    KC_RALT,                            KC_RCTL
  ),
[1] = LAYOUT_all(
  _______, _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,            KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______,
  _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, HC_DSKL, HC_DSKR, _______,
...
void matrix_scan_user(void) {
    LEADER_DICTIONARY() {
        ...
        SEQ_TWO_KEYS(KC_P, KC_L) {
            SEND_STRING(""SS_DOWN(X_LALT) SS_TAP(X_PSCR) SS_UP(X_LALT) );
